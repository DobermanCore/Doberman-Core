...
- **Deferred:** TG3.2 stylometric co-occurrence + TG3.3 raise-only handoff into the subjective surprise/provenance terms (need a per-entity prompt-style baseline); Feature CB cost observability (core seam + loop detector) and budget ceilings (platform).
