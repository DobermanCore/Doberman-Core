...
Reuse requires the owning task and event loop: child tasks and AUTH workers open their own
connections, including tasks and workers whose copied context outlives the original decision.
